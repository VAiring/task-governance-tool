# TG-M24 Pre-Design-Activation Authority Capture
...
> `888a77759cfc59376089b8ebdc509e748638f603` before M24.1 froze its exact
> Runner design and changed the owner from a conditional-only route to mixed
> accepted-predecessor/inactive authority. Words such as accepted, inactive,
> current, or owner inside the captured body describe only that source
> revision and are not current authority. The current replacement is the
