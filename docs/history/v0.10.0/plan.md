> [!CAUTION]
> **NON-AUTHORITATIVE HISTORY — DO NOT USE AS CURRENT DECISION LOG.**
> This file preserves the former plan.md from exact source
...
> only. Current replacement is [plan.md](../../../plan.md).
