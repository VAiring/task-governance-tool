...
> authority-only scope. TG-M24.3B, TG-M24.3C, and TG-M24.4A through
...
- [TG-M24 Verification Runner](tg-m24-verification-runner.md#tg-m24-verification-runner)
  ...
  non-gating TG-M24.1B route, current TG-M24.3A schema-v21 contract, and
  inactive TG-M24.3B/TG-M24.3C-through-TG-M24.CP4
