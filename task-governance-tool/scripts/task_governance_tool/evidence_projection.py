...
module owns byte-exact, sanitized JSON construction and basis rendering.
Physical capture and publication belong to evidence_publication.py. The
builders accept values, not paths, connections, or command output.
"""
