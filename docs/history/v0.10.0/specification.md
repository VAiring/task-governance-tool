> [!CAUTION]
> **NON-AUTHORITATIVE HISTORY — DO NOT USE AS CURRENT PRODUCT CONTRACT.**
> This file preserves the former `docs/specification.md` from exact source
> commit `1ac8c001073b1a4cb29e9de3f0281d8ff2d9aca1`. Internal words such as
> “current”, “approved”, and “implemented” describe that historical source
> only. Current authority is [docs/specification.md](../../specification.md).
