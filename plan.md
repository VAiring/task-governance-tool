...
- An additional platform job runs the closed common-processing,
  CLI-startup, applicable artifact-operation, and Runner-preparation selection
  owned by `tools/test_lanes.py` on Ubuntu 24.04 x86-64 and macOS 15 Apple Silicon with
  ...
  Runner execution is not in this selection.
