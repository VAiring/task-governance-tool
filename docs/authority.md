...
and TG-M24.R5 are accepted predecessors; TG-M24.2A is the sole current unit,
and TG-M24.2B through TG-M24.CP4 remain inactive in the exact sequential order
owned by the routed contract. The
...
R4A, R4V, R3A, R3B, R4B, and R5 are accepted predecessors, M24.1B is
superseded, 2A is current, every later implementation and acceptance unit is
