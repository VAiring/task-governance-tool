...
snapshot v4 accepting source schemas v5-v22, and 23 public command leaves. Its
...
use Python 3.12. Public Runner execution supports Windows, Linux, and macOS under
explicit opt-in. Exact support and
...
through the repository platform entry. Linux/macOS public dispatch connects the POSIX
...
No all-function relocation, file-count target, or Windows-equivalent native
...
The parser exposes exactly 23 command leaves:
...
Runner-process selection. Both hosts also select the public Runner gate module.
