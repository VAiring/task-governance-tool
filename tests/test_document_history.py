...
class DocumentHistoryTests(unittest.TestCase):
    ...
    def test_viewer_split_capture_preserves_exact_source_sections(self):
        relative = "v0.13.0/viewer-section-split.md"
        source_commit = "5d0c41203ee550728ac4f2a0d1f8fdb055b13a65"
        data = (HISTORY_ROOT / relative).read_bytes()
        ...
        sections = (
            (
                ...
                b"## Privacy, Safety, And Stable Errors",
                "viewer-specification.md",
            ),
            (
                "docs/design.md",
                b"## Static Viewer\n",
                b"## Privacy, Safety, And Failure Boundaries",
                "viewer-design.md",
            ),
        )
        self.assertEqual(len(captured), len(sections))
    ...
    def test_runner_plan_authoring_split_capture_preserves_exact_source_sections(self):
        relative = "v0.13.0/runner-plan-authoring-section-split.md"
        source_commit = "aed16ab456d7074f2647b102c14e894430ff7bc2"
        data = (HISTORY_ROOT / relative).read_bytes()
        prefix = data.split(b"````markdown\n", 1)[0]
        self.assertIn(b"NON-AUTHORITATIVE HISTORY", prefix)
        self.assertIn(source_commit.encode("ascii"), prefix)
        ...
        sections = (
            (
                "docs/specification.md",
                b"## Current Runner Plan Authoring And Control Contract\n",
    ...
    def test_runner_execution_split_capture_preserves_exact_source_sections(self):
        relative = "v0.13.0/runner-execution-section-split.md"
        source_commit = "8319b794c37dd8345b78510f5b80371ef537ebb7"
        data = (HISTORY_ROOT / relative).read_bytes()
        prefix = data.split(b"````markdown\n", 1)[0]
        self.assertIn(b"NON-AUTHORITATIVE HISTORY", prefix)
        self.assertIn(source_commit.encode("ascii"), prefix)
        ...
        sections = (
            (
                ...
                b"## Trusted-Local Verification Runner\n",
                b"## Current Runner Plan Authoring And Control Contract",
                "runner-execution-specification.md",
            ),
            (
                "docs/design.md",
                b'<a id="trusted-local-runner-architecture"></a>\n',
                b"## Validation And Test Design",
                "runner-execution-design.md",
            ),
        )
        self.assertEqual(len(captured), len(sections))
        index = (HISTORY_ROOT / "README.md").read_text(encoding="utf-8")
    ...
    def test_evidence_split_capture_preserves_exact_source_sections(self):
        relative = "v0.13.0/evidence-section-split.md"
        source_commit = "c3c9323370ab24f6eddf10694ccf34e9c4ebbc3a"
        data = (HISTORY_ROOT / relative).read_bytes()
        prefix = data.split(b"````markdown\n", 1)[0]
        self.assertIn(b"NON-AUTHORITATIVE HISTORY", prefix)
        self.assertIn(source_commit.encode("ascii"), prefix)
        ...
        sections = (
            ...
            (
                "docs/specification.md",
                b"### Authority Snapshot, Whole-Field Criteria, And References\n",
            ...
            (
                "docs/specification.md",
                b"## Evidence Interpretation And Retired Analyzer Boundary\n",
                b"## Trusted-Local Verification Runner\n",
                "evidence-specification.md",
            ),
            (
