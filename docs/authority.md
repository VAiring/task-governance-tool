...
TG-M24.4A and TG-M24.4B are accepted, and TG-M24.4C is the sole current unit.
TG-M24.4D and TG-M24.CP4 remain inactive
...
belongs only to accepted TG-M24.3C; accepted TG-M24.4A/TG-M24.4B and current
TG-M24.4C own acceptance only;
...
M24.1B is superseded, 3A, 3B, 3C, 4A, and 4B are accepted, 4C is current,
every later acceptance unit is inactive, and indexing or reading them activates
no product behavior.
