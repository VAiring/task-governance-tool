"""Windows executable identity lease owned across the service process call.

The service supplies materialized/scratch roots before native acquisition,
receives only the verified absolute executable Path, and retains final cleanup
acceptance. Shared failure and cleanup-state types remain in the runtime owner.
"""
...
__all__ = ["RunnerFixedExecutableLease"]
